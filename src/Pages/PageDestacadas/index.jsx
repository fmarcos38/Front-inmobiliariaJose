...
function PageDestacadas() {
    ...
    useEffect(() => {
        dispatch(getPropsDestacadas(limit, offset, operacion, tipoPropiedad, precioMin, precioMax, ambientes));
